...
const marketsData = [
  ...
  {
    id: 7,
    question: "Bolivia Presidential Election",
    endTime: Math.floor(Date.now() / 1000) + 86400 * 30,
    totalYesBets: BigInt("7700000000000000000"),
    totalNoBets: BigInt("2300000000000000000"),
    resolved: false,
    volume: "$1.1m",
    category: "Politics",
  },
  {
    id: 8,
    question: "Will Putin meet with Zelensky in 2025?",
    endTime: Math.floor(Date.now() / 1000) + 86400 * 365,
    totalYesBets: BigInt("2800000000000000000"),
    totalNoBets: BigInt("7200000000000000000"),
    resolved: false,
  ...
  {
    id: 9,
    question: "Israel x Hamas ceasefire by August 31?",
    endTime: Math.floor(Date.now() / 1000) + 86400 * 30,
    totalYesBets: BigInt("900000000000000000"),
    totalNoBets: BigInt("9100000000000000000"),
    resolved: false,
    volume: "$6m",
    category: "Geopolitics",
  },
  {
    ...
    endTime: Math.floor(Date.now() / 1000) + 86400 * 70,
    totalYesBets: BigInt("1800000000000000000"),
    totalNoBets: BigInt("8200000000000000000"),
    resolved: false,
    volume: "$2m",
    category: "Politics",
  },
  {
    id: 11,
    question: "Bitcoin above $100k on August 22?",
    endTime: Math.floor(Date.now() / 1000) + 86400 * 30,
    totalYesBets: BigInt("10000000000000000000"),
  ...
  {
    id: 12,
    question: "Ethereum above $4000 on August 22?",
    endTime: Math.floor(Date.now() / 1000) + 86400 * 30,
    totalYesBets: BigInt("9500000000000000000"),
    totalNoBets: BigInt("500000000000000000"),
    resolved: false,
    volume: "$1m",
    category: "Crypto",
  },
  {
    id: 13,
    question: "Bitcoin Up or Down on August 22?",
    endTime: Math.floor(Date.now() / 1000) + 86400 * 30,
    totalYesBets: BigInt("9800000000000000000"),
    totalNoBets: BigInt("200000000000000000"),
    resolved: false,
    volume: "$407k",
    category: "Crypto",
  },
  {
    id: 14,
    question: "UFC Fight Night: Walker vs Zhang",
    endTime: Math.floor(Date.now() / 1000) + 86400 * 30,
    totalYesBets: BigInt("6900000000000000000"),
    totalNoBets: BigInt("3100000000000000000"),
    resolved: false,
    volume: "$439k",
    category: "Sports",
  },
  {
    id: 15,
    question: "Elon Musk # of tweets August 15-22?",
    endTime: Math.floor(Date.now() / 1000) + 86400 * 30,
    totalYesBets: BigInt("9800000000000000000"),
    totalNoBets: BigInt("200000000000000000"),
    resolved: false,
