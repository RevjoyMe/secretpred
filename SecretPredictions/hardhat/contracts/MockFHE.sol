...
// einput will be handled as bytes directly
...
library TFHE {
    ...
    function asEuint64(bytes memory value, bytes memory proof) internal pure returns (euint64) {
    ...
    function asBool(bytes memory value, bytes memory proof) internal pure returns (ebool) {
        // In real implementation, this would decrypt the input  
